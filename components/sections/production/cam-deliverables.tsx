...
const CAMDeliverables = () => {
  const deliverables = [
    {
      title: "Milled Restorations",
      desc: "High-precision zirconia or PMMA crowns and bridges.",
      image: "/images/cam-product.png",
      icon: <Package />
    },
    {
      title: "3D Printed Models",
      desc: "Accurate physical models for clinical validation.",
      image: "/images/imaging-stl.png",
      icon: <ShieldCheck />
    },
    {
      title: "Quality Certificate",
      desc: "Material verification and fit validation report.",
      image: "/images/cam-hero.png",
      icon: <Zap />
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 space-y-8">
            <SectionHeader
              ...
              description="Every milled restoration undergoes rigorous quality control to ensure perfect fit and optimal aesthetics."
            />
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                    Service: EcoDent CAM Production / {item.title}
                  </div>
                </div>
              </div>
            ))}
...
export default CAMDeliverables;
