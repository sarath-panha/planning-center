...
const ImplantDeliverables = () => {
  const deliverables = [
    {
      title: "Planning Report",
      desc: "Detailed 3D analysis and surgical protocol in PDF format.",
      image: "/images/implant-report.png",
      icon: <FileText />
    },
    {
      title: "Surgical Guide",
      desc: "Precision STL design for tooth, mucosa, or bone support.",
      image: "/images/implant-guide.png",
      icon: <Drill />
    },
    {
      title: "Drill Protocol",
      desc: "Sequence and settings for the specific implant system.",
      image: "/images/implant-hero.png",
      icon: <Zap />
    }
  ];
      ...
      <MaxWidthWrapper>
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 space-y-8">
            <SectionHeader
              badge="Case Output"
              title="Manufacturer-Ready Deliverables"
              description="Receive comprehensive digital files and reports ready for immediate clinical application."
            />
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                    Service: EcoDent Implant Planning / {item.title}
                  </div>
                </div>
              </div>
            ))}
...
export default ImplantDeliverables;
