...
const AlignerDeliverables = () => {
  const deliverables = [
    {
      title: "Movement Simulation",
      desc: "Web-viewable link for patient consultation.",
      image: "/images/aligner-setup.png",
      icon: <Monitor />
    },
    {
      title: "Stage-by-Stage STL",
      desc: "Precision meshes ready for 3D printing.",
      image: "/images/imaging-stl.png",
      icon: <FileCode />
    },
    {
      title: "Clinical Report",
      desc: "Detailed IPR and attachment placement protocol.",
      ...
      <MaxWidthWrapper>
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 space-y-8">
            <SectionHeader
              badge="Case Deliverables"
              title="Full Orthodontic Output"
              description="Everything you need to print in-house or send to a manufacturing center for fabrication."
            />
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                    Service: EcoDent Aligner Planning / {item.title}
                  </div>
                </div>
              </div>
            ))}
...
export default AlignerDeliverables;
