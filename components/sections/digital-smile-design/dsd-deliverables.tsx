...
const DSDDeliverables = () => {
  const deliverables = [
    {
      title: "Smile Simulation",
      desc: "High-resolution 2D motivation photos for patients.",
      image: "/images/dsd-simulation.png",
      icon: <ImageIcon />
    },
    {
      title: "3D Digital Wax-up",
      desc: "Manufacturer-ready STL files for prosthetic mock-ups.",
      image: "/images/imaging-stl.png",
      icon: <Layers />
    },
    {
      title: "Facial Integration",
      desc: "3D smile design merged with high-res facial scans.",
      image: "/images/dsd-hero.png",
      icon: <Monitor />
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 space-y-8">
            <SectionHeader
              ...
              title="Aesthetic Deliverables"
              description="High-fidelity visual and technical data to facilitate patient communication and laboratory fabrication."
            />
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                    Service: EcoDent Smile Design / {item.title}
                  </div>
                </div>
              </div>
            ))}
...
export default DSDDeliverables;
