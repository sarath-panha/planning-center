      ...
      <MaxWidthWrapper className="relative z-10">
        <div className="max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white leading-[1.1]">
            Capture Precision. <br />
            <span className="text-primary">Eliminate Doubt.</span>
          </h1>
          <p className="text-xl text-white/70 leading-relaxed max-w-2xl">
            EcoDent Imaging Center provides clinicians with the crystal-clear anatomical data required for advanced diagnosis and predictable treatment planning.
          </p>
