...
const ImagingDeliverables = () => {
  const deliverables = [
    {
      title: "Full DICOM Sets",
      desc: "Unencrypted volumetric data for any planning software.",
      image: "/images/imaging-result.png",
      icon: <Layers />
    },
    {
      title: "Cleaned STL/OBJ",
      desc: "Optimized surface meshes for prosthetics and aligners.",
      image: "/images/imaging-stl.png",
      icon: <FileCode />
    },
    {
      title: "3D Facial Data",
      desc: "Integrated skin topography for facially-driven design.",
      image: "/images/imaging-face.png",
      icon: <Scan />
    },
    {
      title: "HD Clinical Photos",
      desc: "Standardized high-resolution clinical photography sets.",
      image: "/images/imaging-photos.png",
      icon: <Camera />
    }
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2 space-y-8">
            <SectionHeader
              ...
              title="Manufacturer Digital Data"
              description="We provide unencrypted, high-fidelity data formats compatible with all major CAD/CAM planning software suites."
            />
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black uppercase tracking-[0.2em]">
                    Source: EcoDent Digital Library / {item.title}
                  </div>
                </div>
              </div>
            ))}
...
export default ImagingDeliverables;
